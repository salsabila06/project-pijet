            ...
            <div class="content">
                ...
                <nav class="navbar navbar-expand-lg" style="margin-left: 20px">
                    <ul class="navbar-nav" style="text-align: left">
                        <li class="nav-item">
                            <a class="statusMenu " id="menu-berhasil" aria-current="page" href="{{ route('pengguna') }}"><b>
                                    Customer</b></a>
                        </li>
                        <li class="nav-item">
                            <a class="statusMenu ms-5" id="menu-menunggu" aria-current="page"
                                href="{{ route('mitra') }}"><b> Mitra</b></a>
                        </li>
                    </ul>
                                ...
                                <tr>
                                    ...
                                    <td><a>
                                            <button type="button" class="admin-btn" data-bs-toggle="modal"
                                                data-bs-target="#penggunaModal-{{ $data->id }}">
                                                Detail
                                                Pengguna
                                            </button>
                                        </a></td>
                ...
                <div class="card" style="margin-top: 25px">
                    <div class="content">
                        ...
                        <nav class="navbar navbar-expand-lg" style="margin-left: 20px">
                            <ul class="navbar-nav" style="text-align: left">
                                <li class="nav-item">
                                    <a class="statusMenu " id="menu-berhasil"
                                        aria-current="page"href="{{ route('mitrafinance') }}"><b>
                                            Mitra</b></a>
                                </li>
                                <li class="nav-item">
                                    <a
                                        class="statusMenu ms-5"id="menu-menunggu"aria-current="page"href="{{ route('pelanggan') }}"><b>Pelanggan</b>
                                    </a>
                                </li>
                            </ul>
                            <form action="?" class="col-auto ms-auto" style="margin-right: 20px">
                                <div class="input-group mb-3">
                                    <input type="text"class="form-control"
                                        value="{{ request()->search }}"placeholder="Search.."name="search"><button
