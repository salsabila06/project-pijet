                    ...
                    <div class="modal-footer">
                        <div class="container-fluid">
                            <a href="{{ route('pemesanan_Ditolak', $stat->id) }}">
                                <button type="button" class="badge rounded-pill bg-danger mx-auto d-block"
                        ...
                        <div class="container-fluid">
                            <a href="{{ route('pemesanan_berhasil', $stat->id) }}">
                                <button type="button" class="badge rounded-pill bg-primary mx-auto d-block"
                            ...
                            <div class="detail-main">
                                <table>
                                    <tbody>
                                        ...
                                        <nav class="navbar navbar-expand-lg" style="margin-left: 20px">
                                            <ul class="navbar-nav">
                                                <li class="nav-item" style="margin-right: 90px">{{ $stat->updated_at }}
                                                </li>
                                                <li class="nav-item" style="margin-right: 70px">
                                                    {{ $stat->pengguna->username }}</li>
                                                <li class="nav-item" style="margin-right: 70px">
                                                    {{ $stat->jenispijat->harga }}</li>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(key, value) {
                            ...
                            $('#datasTransaksiAjax').append('<td>' + dateFormat +
                                '<td>');
                            $('#datasTransaksiAjax').append('<td>' + value.pengguna
                                .username + '<td>');
                            $('#datasTransaksiAjax').append('<td>' + value.jenispijat
                                .harga + '<td>');
                            $('#datasTransaksiAjax').append('<td>' + value.status +
                                '<td>');
                            $('#datasTransaksiAjax').append('</tr>');
