    ...
    <nav id="navbar" class="navbar">
        <div class="container-fluid">
            ...
            <form class="d-flex" role="search">
                ...
                <a class="btn btn-lg" href="{{ route('logout') }}"><i class="fa fa-sign-out"></i></a>
            </form>
        </div>
    </nav>
</header>
    ...
    <div class="sidebar">
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            @if (Auth::guard('admin')->user()->role == '2')
                <li><a class="nav-link{{ Request::is('pengguna') ? 'active' : '' }}" href="{{ route('pengguna') }}">
                        <i class="fa fa-user"> <span>Pengguna</span></i></a></li>
                <li><a class="nav-link{{ Request::is('tampil_pemesanan_berhasil') ? 'active' : '' }}"
                        href="{{ route('tampil_pemesanan_berhasil') }}">
                        <i class=" fa fa-shopping-cart"><span>Transaksi</span></i></a></li>
                <li><a class="nav-link{{ Request::is('pembatalan') ? 'active' : '' }}"
                        href="{{ route('pembatalan') }}">
                        <i class="fa fa-times"> <span>Pembatalan</span></i></a></li>
            ...
            @elseif(Auth::guard('admin')->user()->role == '3')
                <li><a class="nav-link{{ Request::is('dashboard') ? 'active' : '' }}"
                        href="{{ route('superadmin') }}"><i class="fa fa-home"> <span>Admin</span></i> </a></li>
                <li><a href=""></a></li>
            @endif
        </ul>
    </div>
