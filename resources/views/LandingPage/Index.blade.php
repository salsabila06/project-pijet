            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link"
                            aria-current="page"{{ Request::is('hero') ? 'active' : '' }}
                            href="#hero"><span>Beranda</span></a>
                    </li>
                    &nbsp;
                    <li class="nav-item"><a class="nav-link"
                            aria-current="page"{{ Request::is('komunitas') ? 'active' : '' }}
                            href="#komunitas"><span>Komunitas</span></a>
                    </li>
                    <li class="nav-item"><a class="nav-link"
                            aria-current="page"{{ Request::is('Tentang') ? 'active' : '' }}
                            href="#Tentang"><span>Tentang Kami</span></a>
                    </li>
                    <li class="nav-item"><a class="nav-link"
                            aria-current="page"{{ Request::is('dukungan') ? 'active' : '' }}
                            href="#dukungan"><span>Dukungan</span></a>
                    </li>&nbsp;&nbsp;
    ...
    <section id="hero">
        <div class="container h-100">
            ...
            <div class="col-lg-6 col-xl-7">
                <img src="/image/Herobanner.svg" alt=""
                    class="hero-img position-absolute end-0 bottom-0 img-hero" />
                <img src="/image/Ellipse 10.svg" alt=""
                    class="ellipse-img h-100 position-absolute top-0 start-0" />
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 text-center pb-5">
                    <div class="card-komunitas">
                        <div class="mangkok-icon position-relative mx-auto">
                            <img src="/image/mangkok-icon.svg" alt=""
                ...
                <div class="col-md-4 text-center">
                    <div class="card-komunitas">
                        <div class="mangkok-icon position-relative mx-auto">
                            <img src="/image/batu.svg" alt=""
                                class="position-absolute top-50 start-50 translate-middle" />
                        </div>
                        <h3 class="mt-3">Vitalitas</h3>
                        <p class="sub-titlemt-2">Membantu meningkatkan stamina melalui tekanan, usapan pada bagian
                            tubuh.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4 text-center">
                    <div class="card-komunitas">
                        <div class="mangkok-icon position-relative mx-auto">
                            <img src="/image/orang bertapa.svg" alt=""
                                class="position-absolute top-50 start-50 translate-middle" />
                        </div>
                        <h3 class="mt-3">Rileks</h3>
                        <p class="sub-title mt-2">Meningkatkan ketenangan, mengurangi tingkat kegelisahan dalam diri.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container px-4">
            <div class="row gx-5">
                ...
                <div class="col">
                    <div class="p-3 mt-5">
                        <h3>Tentang Kami</h3>
                        <p>PijetIn merupakan platform yang membantu pengguna dalam memesan dan mengunakan jasa layanan
                            pijat. PijetIn memiliki beberapa macam layanan pijat yang dapat membuat kita merasa rileks.
                        </p>
                        <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    <h3 class="pt-5 pb-3">Pilih pijat panggilan yang kamu mau</h3>
                </div>
            </div>
