...
<div class="tutor">
  ...
  <nav3 class="navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="daftar">
          <li class="nav-item">
...
<div class="tutor">
    <div class="card-body">
      ...
      <h2 class="title ms-5">Pengguna</h2>
    <nav1 class="navbar navbar-expand-lg">
      <div class="container-fluid">
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="pending">
            <li class="nav-item">
              <a class="link-dark" id="menu-berhasil" aria-current="page" href="#">Daftar Pengguna</a>
            </li>
          </ul>
          <div class="cari">
        <form class="d-flex" role="search">
    ...
    <div class="table-responsive-sm">
      ...
      <tbody>
        <tr scope="row" class="isi-style">
          ...
          <td>081226789086</td>
          <td>9022005699012345</td>
          <td><button class="pengguna-btn">Detail Pengguna</button></td>
        </tr>
      </tbody>
