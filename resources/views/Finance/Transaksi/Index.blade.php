...
<div class="tutor">
  ...
  <nav2 class="navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="transaksi">
        <li class="nav-item">
      ...
      <div class="card-overlay">
        <center>
          <div class="card-container">
            <h4 class="title-profil">TRANSAKSI GAGAL</h4>
            <img class="close" src="assets/img/Close_round_fill.svg" alt="user" />
