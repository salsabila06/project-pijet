...
<body>
    <nav class="navbar">
        <div class="container-fluid">
            ...
            <form class="d-flex" role="search">
                ...
                <a class="btn btn-lg" href="#"><i class="fa fa-user"></i></a>
            </form>
        </div>
    </nav>
    ...
    <div class="sidebar">
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li><a href=""> <i class=" fa fa-shopping-cart"> <span>Transaksi</span></i></a> </li>
            <li><a href=""> <i class="fa fa-check-square-o"> <span>Pembatalan</span></i></a> </li>
        </ul>
    </div>
